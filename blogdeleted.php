...
<div class="max-w-[1440px] mx-auto bg-[#FFFCF4] blog">
    <div class="container py-[35px] md:py-[96px]">
            ...
            <div class="">
                <div class="">
                    <div class="flex flex-col md:flex-row gap-y-[20px] md:gap-x-[30px] text-black">
                        ...
                        if ($posts->have_posts()) :
                            while ($posts->have_posts()) : $posts_the_post();

                        ?>
                                <!-- single blog -->

                                <div class="mx-auto h-[466px] w-[370px] bg-white rounded-[12px] shadow-lg">
                                    <a href="<?php the_permalink(); ?>">
                                        <?php
                                        if (has_post_thumbnail()) {
                                            the_post_thumbnail('medium');
                                        } else {
                                            echo                             '<img src="<?php echo get_template_directory_uri()(); ?>/assets/img/blog-pic-1.png" alt="">';
                                        }
                                        ?>
                                    </a>
                                    <div class="p-[20px]">
        ...
        <div class="flex gap-1 mt-[38px] mx-auto justify-center">
