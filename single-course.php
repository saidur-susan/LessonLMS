            ...
            <div class="left-image w-full md:w-8/12 relative ">
                ...
                <div class="price-list-overlay max-w-[350px] absolute top-10 right-10">
                    <div
                        ...
                        <span class="discount-pricefont-bold text-2xl md:text-3xl text-gray-800">$<?php echo esc_html($price); ?> </span>
                        ...
                        <div class="flex flex-col gap-4 font-semibold">
                            ...
                            <div class="icon flex gap-x-2 items-center">
                                ...
                                <p class="text-gray-600"><?php echo esc_html($video_hours) ?> Hours on-demand video</p>
                            </div>
                            ...
                            <div class="icon flex gap-x-2 items-center">
                                ...
                                <p class="text-gray-600"><?php echo esc_html($article_count); ?> Articles</p>
                            </div>
                            ...
                            <div class="icon flex gap-x-2 items-center">
                                ...
                                <p class="text-gray-600"><?php echo esc_html($downloadable_resources); ?> Downloadable resources</p>
                            </div>
                    ...
                    <div class=" border shadow-xl border-gray-300 rounded-2xl p-6 flex flex-col gap-4">
                        ...
                        <div class="flex gap-x-4">
                            ...
                            <div class="text ">
                                ...
                                <p class="text-gray-600 font-bold"><?php echo esc_attr($language); ?></p>
                            </div>
                        </div>
                        <!-- Course details list -->
                        <div class="flex gap-x-4">
                            ...
                            <div class="text ">
                                ...
                                <p class="text-gray-600 font-bold"><?php echo esc_attr($subtitle); ?></p>
                            </div>
                        </div>
                    </div>
