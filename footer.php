...
<div class="max-w-[1440px] w-full pt-[30px] md:pt-[96px] bg-[#2E2100] mx-auto">
    <div class="container px-5 md:px-auto">
        <div class="flex flex-col md:flex-row gap-4 md:gap-10 text-left text-white">

            <div class="w-[100%] md:w-2/5 pr-30 flex flex-col gap-[18px] ">
                <div class="logo font-bold text-[24px] leading-[34px] sen">
                    <a href="#"><?php if (get_theme_mod('footer_logo')) : ?>
                            <img src="<?php echo esc_url(get_theme_mod('footer_logo')); ?>" alt="">
                        <?php endif; ?></span></a>
                </div>
                <?php if (get_theme_mod('footer_about_text')) : ?>
                    <p class=" text-[14px] max-w-[250px] poppins text-[#BFBCB2]">
                        <?php echo get_theme_mod('footer_about_text'); ?></p>
                <?php endif; ?>
                <div class="flex social-icon">
                    <a href="<?php echo esc_url(get_theme_mod('footer_twitter_link', '#')); ?>"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
                            <path fill="#03a9f4" d="M24,4C13,4,4,13,4,24s9,20,20,20s20-9,20-20S35,4,24,4z"></path>
                    ...
                    <a href="<?php echo esc_url(get_theme_mod('footer_facebook_link', '#')); ?>"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
                            <path fill="#039be5" d="M24 5A19 19 0 1 0 24 43A19 19 0 1 0 24 5Z"></path>
                            <path fill="#fff" d="M26.572,29.036h4.917l0.772-4.995h-5.69v-2.73c0-2.075,0.678-3.915,2.619-3.915h3.119v-4.359c-0.548-0.074-1.707-0.236-3.897-0.236c-4.573,0-7.254,2.415-7.254,7.917v3.323h-4.701v4.995h4.701v13.729C22.089,42.905,23.032,43,24,43c0.875,0,1.729-0.08,2.572-0.194V29.036z"></path>
                        </svg></a>

                    <a href="<?php echo esc_url(get_theme_mod('footer_linkedin_link', '#')); ?>"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
                    ...
                    <a href="<?php echo esc_url(get_theme_mod('footer_instragram_link', '#')); ?>"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
            ...
            <div class="w-[100%] md:w-1/5 ml-auto md:-ml-10 md:mt-0 mt-[30px]">
                <p class="text-base text-[#fff] mb-[14px] font-semibold 
                 leading-[28px]">
                    <?php if (get_theme_mod('footer_menu_title_1')) : ?>
                        <?php echo esc_html(get_theme_mod('footer_menu_title_1')); ?></p>
            <?php endif; ?>
            <p class="mb-[28px]"><svg width="130" height="1" viewBox="0 0 130 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="130" height="1" fill="#59554B" />
                </svg>
            </p>

            <div class="flex flex-col gap-[12px] text-[14px] poppins text-[#BFBCB2]  leading-[26px] ">
                <?php
                wp_nav_menu(array(
            ...
            <div class="w-[100%] md:w-1/5 ml-auto md:-ml-10 md:mt-0 mt-[30px]">
                <p class="text-base text-[#fff] mb-[14px] font-semibold leading-[28px]">
                    <?php if (get_theme_mod('footer_menu_title_2')) : ?>
                        <?php echo esc_html(get_theme_mod('footer_menu_title_2')); ?>
                    <?php endif; ?>
                </p>
                <p class="mb-[28px]"><svg width="130" height="1" viewBox="0 0 130 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="130" height="1" fill="#59554B" />
            ...
            <div class="w-[100%] md:w-1/5 ml-auto md:-ml-10 md:mt-0 mt-[30px]">
                ...
                <div class="flex flex-col gap-[12px] text-[14px] poppins text-[#BFBCB2] leading-[26px]">
                    <p class=""><span class="font-semibold text-white ">Location:</span> <?php echo get_theme_mod('footer_location'); ?></p>
                    <p><span class="font-semibold text-white ">Email:</span> <?php if (get_theme_mod('footer_email')) : ?>
                            <?php echo esc_html(get_theme_mod('footer_email')); ?>
                        <?php endif; ?> </p>
                    <a href="000"><span class="font-semibold text-white "> <?php if (get_theme_mod('footer_phone_title')) : ?><?php echo esc_html(get_theme_mod('footer_phone_title')); ?> <?php endif; ?></span> <?php if (get_theme_mod('footer_phone_number')) : ?><?php echo esc_html(get_theme_mod('footer_phone_number')); ?> <?php endif; ?></a>
                </div>
            </div>
        </div>
