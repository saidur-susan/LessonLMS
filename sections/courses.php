...
<div class="container mx-auto py-[40px] md:py-[100px] ">
    ...
    <div class="slicks pb-30">
        <div class="courses-buttons relative  flex flex-col items-center md:flex-row gap-[30px] ">
            <!-- slider button -->
                ...
                ?>
                        ...
                        <div class="courses-slider">
                            <div class="course course-1 active-btn h-[466px] w-[370px] bg-white rounded-[12px] shadow-xl ">
                                ...
                                <div class="course-content h-[50%] p-4 flex flex-col">
                                    ...
                                    <div class="  flex justify-between items-center ">
                                        ...
                                        <div class="">
                                            <a class="poppins bg-[#171100] hover:bg-[#FFB900] text-[18px] leading-[30px] px-4 h-[50px] rounded-full flex justify-center items-center text-white" href="<?php the_permalink() ?>">Book Now</a>
                                        </div>
